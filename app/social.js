export default function Social() {
  return (
    <div className="bg-blue-600 rounded-3xl mx-20 my-8 py-16 px-12 shadow-2xl">
      <div className="flex flex-col lg:flex-row justify-between items-baseline lg:items-center w-full">
